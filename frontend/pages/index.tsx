...
export default function Home({ featuredProjects, numberOfProjects, featuredProducts }) {
  return (
    <Layout>
    ...
    {featuredProducts.length > 0 && (<section>
        <div className="mx-auto">
          <Carousel
            animationSpeed={1000}
            plugins={[
...
export async function getStaticProps() {
  ...
  const res_carrossel = await fetch("http://localhost:1337/carrossels");
