...
export const domDataQueryOptions = () =>
  queryOptions({
    queryKey: ["dom"],
    queryFn: async () => {
      try {
        const totalGoodActions: any[] = [
          {
            ...
            subcod: 1590,
            subname:
              "Requalificação Urbanística E Inclusão Social Da Comunidade do Pilar",
            total: 3150000,
          },
          {
            cod: 5011,
          ...
          },
          {
            ...
            subcod: 2042,
            subname:
              " Promoção Da Gestão E A Articulação Das Ações Ambientais",
            total: 10000,
          },
        ];
        ...
        const totalBadActions: any[] = [
          {
            ...
            subcod: 1012,
            subname:
              "Requalificação Da Mobilidade Urbana - Via Mangue",
            total: 300000,
          },
          {
            cod: 1563,
          ...
          },
          {
            ...
            subcod: 1012,
            subname:
              "Gerenciamento Do Trânsito E Do Transporte Público",
            total: 67285000,
          },
          {
            cod: 1035,
            ...
            subcod: 1012,
            subname:
              "Expansão E Melhoria Da Infraestrutura Da Cttu",
            total: 10000,
          },
          {
            cod: 2723,
            ...
            subcod: 1012,
            subname:
              "Apoio Administrativo Às Ações Da Unidade Orçamentária ",
            total: 17160000,
          },
        ];
...
export const loader = async () =>
  domDataQueryOptions().queryFn({} as any);
