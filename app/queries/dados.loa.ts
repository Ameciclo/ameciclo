...
const fetchLoa = createServerFn().handler(async () => {
  ...
  const goodActionsTags = [
    "0398", "3308", "3378", "3382", "3389", "3786", "3891", "3906", "4122",
    "4123", "4165", "4167", "4185", "4294", "4313", "4482", "4648", "3198",
    "3340", "4202", "4642", "4646", "4176", "4483", "4166", "4074", "4055",
    "3721", "3725", "2755", "2796", "2286", "0569", "3877", "4131", "4235",
    "4679", "4682", "1313", "2967", "2730", "2733", "4650", "4669", "1537",
    "3178", "3187", "4116", "4440", "1896",
  ];
  ...
  const fetchAllData = async () => {
    try {
      const dataPromises = [
        fetchYearlyData(
          "https://dados.pe.gov.br/dataset/38401a88-5a99-4b21-99d2-2d4a36a241f1/resource/5e5e1107-e1ed-4c2c-b258-e19a013f6caa/download/acoes_e_programas_json_2020_20201231.json"
        ),
        fetchYearlyData(
          "https://dados.pe.gov.br/dataset/38401a88-5a99-4b21-99d2-2d4a36a241f1/resource/0a2e8fd7-7a65-46df-bd1b-15f2dfaaded7/download/acoes_e_programas_json_2021_20211231.json"
        ),
        fetchYearlyData(
          "https://dados.pe.gov.br/dataset/38401a88-5a99-4b21-99d2-2d4a36a241f1/resource/55784447-97e8-4fb0-b062-99c368bf6384/download/acoes_e_programas_json_2022_20221231.json"
        ),
        fetchYearlyData(
          "https://dados.pe.gov.br/dataset/38401a88-5a99-4b21-99d2-2d4a36a241f1/resource/421e1035-ef96-4ac9-99cc-07a34ab93444/download/acoes_e_programas_json_2023_20231230.json"
        ),
        fetchYearlyData(
        ...
        fetchYearlyData(
          "https://dados.pe.gov.br/dataset/38401a88-5a99-4b21-99d2-2d4a36a241f1/resource/bd2f90f2-3cc1-4b46-ab8d-9b15a1b0d453/download/acoes_e_programas_json_2025_20250716.json"
        ),
      ];

      const [data2020, data2021, data2022, data2023, data2024, data2025] =
        await Promise.allSettled(dataPromises);

      const getData = (result: any) =>
        result.status === "fulfilled"
          ? result.value
          : { budgeted: 0, executed: 0, totalBudgeted: 0 };
      ...
      try {
        ...
        if (response.ok) {
          ...
          actions2025 = d.campos || [];
        } else {
          errors.push({
            url: "https://dados.pe.gov.br/dataset/.../acoes_e_programas_json_2025_20250716.json",
        ...
        errors.push({
          url: "https://dados.pe.gov.br/dataset/.../acoes_e_programas_json_2025_20250716.json",
          error: errorMessage || "Erro ao carregar tabela",
        });
      }
