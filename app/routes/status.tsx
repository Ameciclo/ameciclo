...
export async function loader({ request }: LoaderFunctionArgs) {
    ...
    const services = [
        ...
        { name: 'Serviço Externo - Associe-se', url: 'docs.google.com/forms/d/e/1FAIpQLSeBboZ6fDhGEuJjVSyt7r3tTe5FF8VJH1gKt95jq6JslrwOdQ/viewform' },
        { name: 'Serviço Externo - Participe', url: 'participe.ameciclo.org' },
    ];
