    ...
    <>
      ...
      <div className="min-h-screen bg-linear-to-b from-gray-50 to-white">
        ...
        <div className="relative">
          <div className="absolute left-1/2 top-0 bottom-0 w-px bg-linear-to-b from-gray-300 via-green-400 to-green-600 -translate-x-1/2" />
          ...
          >
            <div className="relative inline-block">
              ...
              <div className="inline-block bg-green-500 text-white px-5 py-2 rounded-full text-sm font-semibold shadow-xs relative z-10">Ameciclo</div>
            </div>
          </motion.div>
