                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="https://dados.pe.gov.br/dataset/acoes-e-programas" target="_blank" rel="noopener noreferrer" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Ações e programas - Portal de Dados Abertos de Pernambuco</a></li>
                                <li><a href="https://dados.pe.gov.br/dataset/despesas-gerais" target="_blank" rel="noopener noreferrer" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Despesas gerais - Portal de Dados Abertos de Pernambuco</a></li>
                                <li><a href="https://dados.pe.gov.br/dataset/all-pagamentos" target="_blank" rel="noopener noreferrer" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Pagamentos - Portal de Dados Abertos de Pernambuco</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="https://semas.pe.gov.br/grafico-inventario-gee/" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Gráfico – Inventário de Gases de Efeito Estufa de Pernambuco</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="https://dados.pe.gov.br/dataset/acoes-e-programas/resource/bd2f90f2-3cc1-4b46-ab8d-9b15a1b0d453" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Ações e Programas - 2025</a></li>
                                <li><a href="https://dados.pe.gov.br/dataset/acoes-e-programas/resource/6d2fff01-6bb7-43c2-baea-c82a5cdfb206" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Ações e Programas - 2024</a></li>
                                <li><a href="https://dados.pe.gov.br/dataset/acoes-e-programas/resource/421e1035-ef96-4ac9-99cc-07a34ab93444" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Ações e Programas - 2023</a></li>
                                <li><a href="https://dados.pe.gov.br/dataset/38401a88-5a99-4b21-99d2-2d4a36a241f1/resource/55784447-97e8-4fb0-b062-99c368bf6384/download/acoes_e_programas_json_2022_20221231.json" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Ações e Programas - 2022</a></li>
                                <li><a href="https://dados.pe.gov.br/dataset/38401a88-5a99-4b21-99d2-2d4a36a241f1/resource/0a2e8fd7-7a65-46df-bd1b-15f2dfaaded7/download/acoes_e_programas_json_2021_20211231.json" className="text-ameciclo hover:underline focus:outline-hidden focus:ring-2 focus:ring-ameciclo">Ações e Programas - 2021</a></li>
                            </ul>
                        </div>
                    </div>
                </section>
