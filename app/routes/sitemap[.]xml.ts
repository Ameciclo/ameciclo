...
const STATIC_ROUTES: Array<{
  ...
  { path: "/dados/chamados-emergencia", changefreq: "weekly", priority: 0.7 },
  { path: "/dados/execucao-cicloviaria", changefreq: "weekly", priority: 0.7 },
  { path: "/dados/ideciclo", changefreq: "weekly", priority: 0.7 },
  { path: "/dados/orcamento-pernambuco", changefreq: "weekly", priority: 0.7 },
  { path: "/dados/orcamento-recife", changefreq: "weekly", priority: 0.7 },
  { path: "/dados/perfil", changefreq: "weekly", priority: 0.7 },
  { path: "/dados/sinistrosfatais", changefreq: "weekly", priority: 0.7 },
  { path: "/dados/vias-inseguras", changefreq: "weekly", priority: 0.7 },
