...
export function WorkGroupsSection({ darkMode }: WorkGroupsSectionProps) {
  return (
    <div className={`border rounded-xl shadow-lg p-8 ${darkMode ? "bg-linear-to-br from-gray-800 to-gray-700 border-gray-600" : "bg-linear-to-br from-emerald-50 to-teal-50 border-emerald-200"}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={`backdrop-blur-sm p-6 rounded-lg border ${darkMode ? "bg-gray-700/80 border-gray-600" : "bg-white/80 border-emerald-100"}`}>
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg border border-emerald-100">
          <div className="flex items-center gap-2 mb-3">
