            ...
            <div className="mx-auto text-center my-12 md:my-24">
                <div className="relative inline-flex items-center justify-center ">
                    <svg
                        ...
                        fill="none"
                        className="absolute bottom-[-30px] left:0  transform scale-x-105 drop-shadow-lg shrink-0"
                    ...
                    <h1 className=" text-3xl sm:text-5xl font-bold bg-[#CE4831] text-white rounded-[2.5rem] shadow-[0px_6px_8px_rgba(0,0,0,0.25)] inline-flex items-center justify-center h-24 px-8.75 py-4 gap-4 shrink-0 relative z-10">
                        {title}
                    </h1>
                </div>
                {subtitle && (
        ...
        <section className="relative z-1 mx-auto container bg-transparent">
            <div className="mx-auto text-center my-12 md:my-24">
                <div className="relative inline-flex items-center justify-center ">
                    ...
                    <h1 className="text-3xl w-full m-0 mb-10 p-0 sm:text-5xl font-bold bg-transparent text-gray-700 inline-flex items-center justify-center py-4 gap-4 shrink-0 relative z-10">
                        {title}
                    </h1>
                </div>
                {subtitle && (
...
export const StatisticsBoxIdeciclo2 = ({ title, boxes, subtitle = "" }: any) => {
    return (
        <section className="mx-auto container">
            <div className="mx-auto text-center my-12 md:my-24">
                <div className="relative inline-flex items-center justify-center">
                    <h1 className="text-4xl sm:text-5xl font-bold bg-[#6DBFAC] text-gray-800 rounded-[2.5rem] shadow-[0px_6px_8px_rgba(0,0,0,0.25)] inline-flex items-center justify-center px-8 py-[.75rem] pb-4 lg:p-6 lg:pb-8 lg:px-8 gap-4 shrink-0 relative z-10 max-w-[95%] lg:max-w-full">
                        {title}
                    </h1>
                </div>
                {subtitle && (
