...
export const ExplanationBoxesIdeciclo = ({ boxes }: { boxes: Box[] }) => {
  ...
  return (
    <section className="relative w-100">
      <section className="relative z-1 container mx-auto lg:w-4/6 my-5 md:my-6 rounded-sm p-12 overflow-auto">
        <div className="flex p-6 justify-between items-center mb-4">
          <div className="relative inline-flex items-center justify-center">
            ...
            <svg
              ...
              viewBox="0 0 341 80"
              className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-[120%] shrink-0  z-[-1]"
          ...
          <div className="flex items-center">
            ...
            <button
              onClick={handleNext}
              className=" p-4 rounded-full ml-2 text-lg font-bold leading-none shadow-xs transform scale-y-150">
              {'>'}
            </button>
        ...
        <div className="relative z-[-2] top-[-50px] text-gray-800 p-12 py-24 mx-auto bg-gray-100 shadow-2xl">
          {isLoading ? (
            <div className="space-y-3">
              <div className="h-4 bg-gray-300 rounded-sm animate-pulse"></div>
              <div className="h-4 bg-gray-300 rounded-sm animate-pulse w-5/6"></div>
              <div className="h-4 bg-gray-300 rounded-sm animate-pulse w-4/6"></div>
              <div className="h-4 bg-gray-300 rounded-sm animate-pulse w-3/4"></div>
            </div>
          ) : (
